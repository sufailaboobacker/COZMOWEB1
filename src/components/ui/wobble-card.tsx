...
export const WobbleCard = ({
  ...
  return (
    ...
    >
      <div
        className="relative h-full [background-image:radial-gradient(88%_100%_at_top,rgba(255,255,255,0.4),rgba(255,255,255,0))] sm:mx-0 sm:rounded-2xl overflow-hidden transition-all duration-300"
        style={{
